# -*- coding: utf-8 -*-
"""Copy of CS110_Project6_Part1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gse4Ardz-MBa00ggSLieZ5RzSUjBSlnS
...
the "word_tokenization_normalization(text)" is a text input function which normalizes each word used and the command breaks down the sentence into words

also


*   Lowercases all letters
*   The command removes all non aphabet characters and punctuation.
...
# Example continuation: tokenize and normalize text
...
# Make sure to download NLTK resources first (only once needed)
import nltk
nltk.download('punkt')
nltk.download('stopwords')
# Download the 'punkt_tab' resource as suggested by the traceback
nltk.download('punkt_tab')

meaningful_words = word_tokenization_normalization(pride_prejudice_text)
print(meaningful_words) # Print the meaningful_words list to see the output
...
# You need to ensure those cells have been executed before running this one.

# Get meaningful words from the text
meaningful_words = word_tokenization_normalization(pride_prejudice_text)

# Optional: View a sample
print(meaningful_words[:20])  # Display the first 20 words

def create_word_frequency_dict(words):
    """
    Takes a list of words and returns a dictionary with word frequencies.

    Parameters:
    - words (list): A list of cleaned, normalized words.
...
# Example usage
word_frequency = create_word_frequency_dict(meaningful_words)
...
# Example usage
word_counts = [
    ('bennet', 15), ('know', 14), ('say', 11), ('bingley', 11),
    ('visit', 11), ('dear', 10), ('mrs', 9), ('wife', 7),
    ('girl', 7), ('man', 6), ('good', 6), ('daughter', 6),
    ('long', 6), ('come', 6), ('little', 5)
]
